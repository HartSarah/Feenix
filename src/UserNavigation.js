...
export default class UserNavigation extends React.Component {
  ...
  render() {
    ...
    if (this.state.userProfile === true) {
      createedit = (
        <button className="difbutton" onClick={this.displayEditProfile}>
          Edit Profile
        </button>
      );
      deletebutton = (
        <button className="difbutton" onClick={this.deleteFunction}>
          Delete Your Profile
        </button>
      );
    } else if (this.state.userProfile === false) {
      createedit = (
        <button className="difbutton" onClick={this.displayCreateProfile}>
          Create New Profile
        </button>
      );
      deletebutton = null;
    ...
    return (
      <>
        <div className="container text-center usernav-box">
          ...
          <button
            className="difbutton"
            onClick={this.displayEntertainerDashboard}
          >
            Entertainer Dashboard
          </button>
          <button className="difbutton" onClick={this.displayUserSearch}>
            User Search
          </button>
          <button className="difbutton" onClick={this.displayProfileViewer}>
            View Profile
          </button>
          {deletebutton}
          <button className="difbutton" onClick={this.logOut}>
            Logout
          </button>
          <hr
            style={{
